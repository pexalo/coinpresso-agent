...
//
// SCOPE is a recommendation, not a rule. "This brief asked for six sections
// and the writer wrote five" is about one post. "The draft reads as
// machine-written" is about every post, and making it a standing rule is the
// only thing that stops it recurring. The operator can always override.
// ---------------------------------------------------------------------------
...
const RULES: Rule[] = [
  {
    ...
    scope: "standing",
    why: "This is a rule about how every internal link is written, not about this post.",
  },
  {
    id: "invented-page",
    ...
    scope: "standing",
    why: "Inventing a URL is a fault worth blocking on every post.",
  },
  {
    id: "internal-links-short",
    test: /(\d+) internal links? to coinpresso\.io \(needs 3-5\)/,
    cause: `Only $1 internal link(s). The house minimum is three, and the writer could not find more that fit.`,
    note: `Link these coinpresso.io pages in this post, with anchor text that names each one: \n  - \n  - \n  - \nWork them into the sections where they are genuinely relevant. Do not add a links paragraph at the end.`,
    scope: "run",
    why: "Which pages are relevant depends on this topic. Name them here.",
  },
  {
    ...
    scope: "standing",
    why: "The cap applies to every post.",
  },
  {
    id: "external-links",
    ...
    scope: "standing",
    why: "Citation density is a house standard, not a one-off.",
  },
  {
    id: "machine-written",
    ...
    scope: "standing",
    why: "The client flagged this phrasing as AI-derived — it should never appear again.",
  },
  {
    id: "closer-repeat",
    ...
    scope: "standing",
    why: "Repetition across posts is the fault — a standing rule is what stops it.",
  },
  {
    id: "opener-repeat",
  ...
  },
  {
    ...
    scope: "run",
    why: "Usually a one-off miss rather than a standing fault.",
  },
  {
    id: "intro-shape",
  ...
  },
  {
    ...
    scope: "run",
    why: "The outline belongs to this brief.",
  },
  {
    id: "paragraph-size",
    ...
    scope: "standing",
    why: "Paragraph length is a house standard.",
  },
  {
    id: "link-spacing",
    ...
    scope: "standing",
    why: "Link spacing is a house standard.",
  },
  {
    id: "sentence-variety",
    ...
    scope: "standing",
    why: "Rhythm is a house standard.",
  },
  {
    ...
    scope: "standing",
    why: "Promising a structure and not rendering it is a fault on any post.",
  },
  {
    id: "ledger-markers",
    ...
    scope: "standing",
    why: "Markers should never reach a draft.",
  },
  {
    id: "truncated",
    ...
    scope: "run",
    why: "A technical limit on this run, not a rule for every post.",
  },
  {
    id: "anchor-length",
    ...
    scope: "standing",
    why: "A house standard, though the pipeline normally fixes it without asking.",
  },
];
